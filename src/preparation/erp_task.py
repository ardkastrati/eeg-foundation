...
split = {
    "train": {
                ...
                "MI_GVH": ["G01.mat", "G02.mat", "G03.mat", "G04.mat", "G05.mat", "G06.mat", "G07.mat", "G08.mat", "G09.mat", "G10.mat", "H01.mat", "H02.mat", "H03.mat", "H04.mat", "H05.mat", "H06.mat", "H07.mat", "H08.mat", "H09.mat", "H10.mat", "V01.mat", "V02.mat", "V03.mat", "V04.mat", "V05.mat", "V06.mat", "V07.mat", "V08.mat", "V09.mat", "V10.mat"],
                ...
                "MI_SCI": ["P01", "P02", "P03", "P04", "P05", "P06", "P07", "P08"],
                ...
                "ERP_BICF": ['Subject1', 'Subject2', 'Subject3', 'Subject4', 'Subject5', 'Subject6', 'Subject7', 'Subject8', 'Subject9', 'Subject10', 'Subject11', 'Subject12', 'Subject13', 'Subject14', 'Subject15', 'Subject16', 'Subject17', 'Subject18', 'Subject19', 'Subject20', 'Subject21', 'Subject22', 'Subject23', 'Subject24', 'Subject25', 'Subject26', 'Subject27', 'Subject28', 'Subject29', 'Subject30', 'Subject31', 'Subject32', 'Subject33', 'Subject34', 'Subject35'],

                "RS_ALPHA": ['subject_0', 'subject_8', 'subject_9', 'subject_10', 'subject_11', 'subject_12', 'subject_13', 'subject_14', 'subject_15', 'subject_16', 'subject_17'],
    ...
    "test":  {
                ...
                "MI_BBCI_IV_Graz_b": ["B0801.mat", "B0802.mat", "B0803.mat", "B0804.mat", "B0805.mat", "B0901.mat", "B0902.mat", "B0903.mat", "B0904.mat", "B0905.mat"],
                ...
                "ErrP_MERP": ["Subject06"],
                "ERP_ANA":  ["Subject1", "Subject2", "Sbject3", "Subject4", "Subject5", "Subject6", "Subject7"],
                ...
                "ERP_BICF": ['Subject36', 'Subject37', 'Subject38', 'Subject39', 'Subject40', 'Subject41', 'Subject42', 'Subject43'],
...
map_labels = {
    "MI_Limb": {
        ...
        'Feet': "left foot and right foot imagined movement",
        'Both_Hands': "left hand and right hand imagined movement",
    ...
    "MI_BBCI_IV_Graz_a": {
        ...
        'keep opening eyes': 'eye no movement eye open',
    ...
    "MI_II": {
        # MI_II
        'imagines mental word association': "imagined mental word association",
        'imagines mental subtraction': "imagined mental subtraction",
        'imagines spatial navigation': "imagined spatial navigation",
        'imagines moving right hand': "right hand imagined movement",
        'imagines moving both feet': "left foot and right foot imagined movement",
    },
    "MI_LR": {
        # MI_LR
    ...
    "MI_eegmmidb": {
        ...
        'open and close both fists': 'left hand and right hand movement left fist and right fist open and close',
        'imagine opening and closing both fists': 'left hand and right hand movement left fist and right fist imagined open and close',
        ...
        'open and close both feet': 'left foot and right foot movement open and close',
        'imagine opening and closing both feet': 'left foot and right foot imagined movement open and close',
    },
    "MI_HGD": {
        # HGD
        'feet': 'left foot and right foot movement clenching toes',
        'left hand': 'left hand movement sequential finger-tapping',
        'rest': 'rest',
        'right hand': 'right hand movement sequential finger-tapping'
    },
    "MI_Two": {
        # Two
    ...
    "MI_SCP": {
        ...
        # SCP
        # 5f
        'imagines moving thumb': 'imagined thumb movement',
    ...
    "MI_SCI": {
        ...
        'Class cue disappears and participant starts to attempt multiple self-paced movements of palmar grasp': 'hand attempted movement palmar grasp',
        'Class cue disappears and participant starts to attempt multiple self-paced movements of hand opening': 'hand attempted movement hand opening',
        ...
        'There is a Go cue on the screen and participant starts to perform palmar grasp': 'hand attempted movement palmar grasp',
        'There is a Go cue on the screen and participant starts to perform hand opening': 'hand attempted movement hand opening',
        'Participant takes a break': 'rest',
        'Participant moves and blinks eyes': 'eye movement eye saccade and eye blink',
        'Participant is in resting state': 'rest',
        'Participant performs supination': 'hand attempted movement supination',
        'Participant performs pronation': 'hand attempted movement pronation',
        'Participant performs hand opening': 'hand attempted movement hand opening',
        'Participant performs palmar grasp': 'hand attempted movement palmar grasp',
        'Participant performs lateral grasp': 'hand attempted movement lateral grasp',
    },
    "ErrP_BCI_NER": {
        # ErrP_BCI_NER
        'There is a feedback on the screen which indicates that the selected item is similar to the expected item': 'without error-related potential',
        'There is a feedback on the screen which indicates that the selected item is different from the expected item': 'with error-related potential',
    },
    "ErrP_MERP": {
        # ErrP_MERP
        'The cursor moves to correct diretion': 'without error-related potential',
        'The cursor moves to wrong direction': 'with error-related potential',
    },
    "ERP_ANA": {
        # ERP_ANA
        "is no event-related potential": "without event-related potential",
        "is an event-related potential": "with event-related potential",
    },
    "ERP_BBI": {
        # ERP_BBI
        "is no event-related potential": "without event-related potential",
    ...
    "RS_SPIS": {
        ...
        "Participant is in resting state and tries to keep opening eyes": "eye no movement eye open",
    }
}

datasets = ["ERP_ANA", "ERP_BBI", "ERP_BICD", "ERP_BICF"]
# datasets = ["ErrP_BCI_NER", "ErrP_MERP"]
prepared_data_directory = "/itet-stor/kard/deepeye_storage/foundation_prepared/"
erp_overall = {"train": [], "test": []}
    ...
    for i, unit in tqdm(enumerate(all_units), total=len(all_units)):
        ...
        for j, index in enumerate(non_empty_indices[:-1]):
            ...
            if isinstance(label, str):
                ...
                label = ''
            for key, value in map_labels[dataset].items():
                if key in label:
                    label = value
                    break
            descriptions.append((label.strip(), index, non_empty_indices[j + 1]))
        ...
        for (description, start, end) in descriptions:
            ...
            if dataset in split["train"] and [el in unit for el in split["train"][dataset]].count(True) > 0:
                erp_overall["train"].append({"input": [unit], "label": label, "length_seconds": float(length_seconds), "start": start, "end": end})
            if dataset in split["test"] and [el in unit for el in split["test"][dataset]].count(True) > 0:
                erp_overall["test"].append({"input": [unit], "label": label, "length_seconds": float(length_seconds), "start": start, "end": end})

    # Save as a json the body part task
    with open("erp_all.json", "w") as f:
        json.dump(erp_overall, f)
