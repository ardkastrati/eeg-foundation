...
if train: 
        ...
        with open("/home/schepasc/eeg-foundation/indices_and_labels/tuab_train_labeled", 'r') as file:
                tuab_train = json.load(file)
else: 
        with open("/home/schepasc/eeg-foundation/indices_and_labels/tuab_eval_labeled", 'r') as file:
                tuab_train = json.load(file)
